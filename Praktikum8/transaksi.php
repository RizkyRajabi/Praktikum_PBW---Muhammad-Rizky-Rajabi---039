...
$pelanggan_result = $conn->query("SELECT ID, Nama FROM
Pelanggan");
?>
...
<body>
  <div class="container mt-4">
    ...
    <form method="post" action="proses_transaksi.php">
      <div class="mb-3">
        <label for="pelanggan_id" class="form-
label">Pilih Pelanggan</label>
      ...
      <h3>Daftar Buku</h3>
      <div class="mb-3">
        <label for="buku_id" class="form-label">Pilih
          Buku</label>
        <select class="form-select" name="buku[1][id]"
          id="buku_id" required>
      ...
      <div class="mb-3">
        <label for="kuantitas" class="form-
